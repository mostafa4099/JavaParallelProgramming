package com.mostafa.Locks_03.Try_02;
...
//                try {
//                    // Reentrant_01 lock help to concurrently complete task to all thread.
...
//                    itemsToAdd = 0;
//                    Thread_01.sleep(300); // time spent writing
...
//                try {
//                    Thread_01.sleep(100); // time spent searching
//                    itemsToAdd++;
...
//            }
            ...
            // Reentrant_01 lock passes other threads in waiting stage. So it takes more time.
